  ...
  return (
    <main className="min-h-screen p-8 md:p-8 lg:p-16 container mx-auto">
      <div className="hero-section mt-16">
        <p className="greetings uppercase text-center font-bold text-[80px] md:text-[160px] lg:text-[220px] xl:text-[320px]">
          Hello
        </p>
      </div>
      <div className="text-center -mt-20 md:-mt-28 lg:-mt-40 xl:-mt-64">
        ...
        <p className="uppercase text-xl md:text-4xl lg:text-5xl xl:text-6xl text-sky-400 font-semibold">
          Fahim Shahriyer
        </p>
      </div>
      <div className="mt-24 xl:mt-56 grid gap-4 grid-cols-1 md:grid-cols-3 pr-4 md:pr-24 pl-4 md:pl-24">
      ...
      <div className="mt-8 grid gap-4 grid-cols-1 md:grid-cols-3 md:pr-24 pl-4 md:pl-24">
        <div className="col-span-3 md:col-span-2">
          <p className="text-center md:text-right text-sky-500 text-sm">
            contact
          </p>
        </div>
        <div className="col-span-3 md:col-span-1 md:mt-0">
